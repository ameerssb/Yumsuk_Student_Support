...
save[1].addEventListener('click',
  function(){
    for(let i=0; i<tab_count; i++){
      ...
      if(tabs[i].ariaSelected == 'true' && i == 2){
        if(o_level_status.value == 'One Sitting'){
          o_level_error.innerHTML = '';
          // to_dict(list_3,data_3_1,data_3_1_validate);
          func_data(data_3_1_validate,education_1_error);          
          valid = checker(education_1_error);
          if(valid == true){
            console.log('Yes');
          }
          ...
          // to_dict(list_3,data_3_2,data_3_2_validate);
          func_data(data_3_2_validate,education_2_error);          
          valid = checker(education_2_error);
          if(valid == true){
            console.log('Yes');
          }          
        }
        else if(o_level_status.value == 'Awaiting Result'){
          o_level_error.innerHTML = '';
          func_data(data_3_3_validate,education_3_error);          
          valid = checker(education_3_error);
          if(valid == true){
            console.log('Yes');
          }
        }
        else{
          o_level_error.innerHTML = 'This field is required';          
        }
      }
      if(tabs[i].ariaSelected == 'true' && i == 3){
        to_dict(list_4,data_4_1,data_4_1_validate);        
